...
var _createClass = function () { function defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if ("value" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } } return function (Constructor, protoProps, staticProps) { if (protoProps) defineProperties(Constructor.prototype, protoProps); if (staticProps) defineProperties(Constructor, staticProps); return Constructor; }; }(); //only works is jquery is installed in node modules
...
var RevealOnScroll = function () {
  ...
  _createClass(RevealOnScroll, [{
    ...
    value: function createWaypoints() {
      var that = this; //
      this.itemToReaveal.each(function () {
...
var Modal = function () {
  ...
  _createClass(Modal, [{
    ...
    value: function keyPressHandler(e) {
      if (e.keyCode == 27) {
        //where 27 is the keybord value of the esc key.
        this.closeModal();
      }
    }
  }, {
